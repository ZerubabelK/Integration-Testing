...
export default function Login() {
  ...
  useEffect(() => {
    document.title = "Login | Etcrewservices";
  }, []);
  return (
        ...
        >
          ...
          <div className="space-y-1 text-sm">
            ...
            <div className="flex justify-end text-xs dark:text-gray-400">
              <a rel="noopener noreferrer" href="/forget">
                Forgot Password?
              </a>
            </div>
          </div>
          <button className="sign-in block w-full p-3 text-center rounded-sm dark:text-white dark:bg-green-400">
            Sign In
          </button>
        </form>
