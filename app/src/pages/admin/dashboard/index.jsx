...
import DashboardHeader from "../../../components/admin/orders/DashboardHeader";
          ...
          <div className="pt-6 2xl:container">
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              <div className="md:col-span-2 lg:col-span-1">
                <div className="h-full space-y-6 group p-6 sm:p-8 rounded-3xl text-black bg-white border border-gray-200/50 dark:shadow-none bg-opacity-50 shadow-2xl shadow-gray-600/10">
                  <svg
                  ...
                  <table className="w-full text-gray-600 dark:text-gray-200">
                    <tbody>
                      <tr>
                        <td className="py-2 text-gray-600">Tailored ui</td>
                        <td className="text-gray-600">896</td>
                        <td>
                          <svg
                      ...
                      <tr>
                        <td className="py-2 text-gray-600">Customize</td>
                      ...
                      <tr>
                        <td className="py-2 text-gray-600">Other</td>
              ...
              <div>
                <div className="h-full group p-6 sm:p-8 rounded-3xl bg-white border border-gray-200/50 dark:shadow-none shadow-2xl shadow-gray-600/10">
                  ...
                  <table className="mt-6 -mb-2 w-full text-gray-600">
                    <tbody>
                      <tr className="dark:text-gray-300">
                        <td className="py-2 text-gray-600">From new users</td>
                        <td className="text-gray-600">896</td>
                        <td>
                          <svg
                            className="ml-auto w-16"
                      ...
                      <tr className="dark:text-gray-300">
                        <td className="py-2 text-gray-600">From old users</td>
                        <td className="text-gray-600">1200</td>
                        <td>
                          <svg
                            className="ml-auto w-16"
              ...
              <div>
                <div className="group p-6 sm:p-8 rounded-3xl bg-white border border-gray-200/50 dark:shadow-none bg-opacity-50 shadow-2xl shadow-gray-600/10 lg:h-full">
                  <svg
                  ...
                  <div className="mt-6">
                    <h5 className="text-center text-xl text-gray-700">
                      Ask to customize
                    </h5>
                    <div className="mt-2 flex justify-center gap-4">
